        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <p className="text-muted-foreground mt-3 max-w-xl text-sm leading-relaxed">
              Prominent manufacturer of Heavy Duty MS Gratings, Galvanised Floor Gratings and SS304 Stainless Steel Gratings — precision welded and built for demanding industrial environments.
            </p>
          </div>
            ...
            {products.map((product, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {product.delivery && (
                    <div className="mb-4">
                      <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-green-50 text-[11px] font-medium text-green-700 border border-green-200">
                  ...
                  <button
                    ...
                    className="w-full btn-pill-primary px-5 py-2.5 text-sm gap-2 justify-center"
                  >
        ...
        {enquiryProduct && (
          ...
          >
            <motion.div
              ...
              className="bg-card rounded-2xl border border-border shadow-2xl w-full max-w-md p-6 relative"
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-5">
                For: <span className="text-foreground font-medium">{enquiryProduct}</span>
              </p>
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full btn-pill-primary px-6 py-3 text-sm gap-2 justify-center"
                >
                  That's it — Send Enquiry <ArrowRight className="w-4 h-4" />
                </button>
              </div>
            </motion.div>
          </motion.div>
